...
* [x] Implemented ScrollView in the details page to see entire tweet with images (if any)
* [x] Automatically refresh favorite/retweet information when returned to the timeline activity
...
Describe any challenges encountered while building the app: One difficulty I had was positioning my icons and app logo in the actionbar to be aligned to a side of the screen. So, I decided to use a toolbar instead. Another challenge I encountered was being able to automatically reload information about a tweet on timeline after changes were made in the details page. I was receiving a memory error and timeout with my implementation, but realized that I was making the same network call twice in a row, in two different methods.
